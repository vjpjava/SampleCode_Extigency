...
import com.exigency.exigencycare.Model.Hospitals;
import com.exigency.exigencycare.Model.Labs;
import com.exigency.exigencycare.exigencycareapp.DetailHospitalActivity;
...
public class SearchHospitalAdapter extends BaseAdapter {
    ...
    ArrayList<Hospitals> doctors;

    public SearchHospitalAdapter(Activity c, ArrayList<Hospitals> doc) {
        mContext = c;
        this.doctors = doc;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, DetailHospitalActivity.class);
