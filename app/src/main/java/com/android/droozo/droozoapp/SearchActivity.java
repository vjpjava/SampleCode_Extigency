...
public class SearchActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private EditText edSearchName, edSearchCity, edSearchLocation;
    ResponseData data;
    ...
    public void setBodyUI() {
        ...
        txtSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("CITY", edSearchCity.getText().toString());
        ...
        edSearchCity = (EditText) findViewById(R.id.edSearchCity);
        edSearchCity.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
        ...
        edSearchLocation.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    if (edSearchCity.getText().toString().trim().length() > 0) {
                        callServiceForLocation(edSearchCity.getText().toString());
                    } else {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        } else if (edSearchCity.isFocused()) {
            edSearchCity.setText(data.getCity_list()[position]);
