 ...
 */
public class MartInnerFragment5 extends Fragment {
    private View view;
    private Activity activity;
    private GridView gridView;
    private static int pos;

    public static MartInnerFragment5 newInstance(int i) {
        MartInnerFragment5 profileFragment = new MartInnerFragment5();
        pos = i;
        return profileFragment;
    }


    public MartInnerFragment5() {
    }
