 ...
 */
public class MartInnerFragment3 extends Fragment {
    private View view;
    private Activity activity;
    private GridView gridView;
    private static int pos;

    public static MartInnerFragment3 newInstance(int i) {
        MartInnerFragment3 profileFragment = new MartInnerFragment3();
        pos = i;
        return profileFragment;
    }


    public MartInnerFragment3() {
    }
