 ...
 */
public class MartInnerFragment7 extends Fragment {
    private View view;
    private Activity activity;
    private GridView gridView;
    private static int pos;

    public static MartInnerFragment7 newInstance(int i) {
        MartInnerFragment7 profileFragment = new MartInnerFragment7();
        pos = i;
        return profileFragment;
    }


    public MartInnerFragment7() {
    }
