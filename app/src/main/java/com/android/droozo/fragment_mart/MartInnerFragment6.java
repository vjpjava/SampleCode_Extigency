 ...
 */
public class MartInnerFragment6 extends Fragment {
    private View view;
    private Activity activity;
    private GridView gridView;
    private static int pos;

    public static MartInnerFragment6 newInstance(int i) {
        MartInnerFragment6 profileFragment = new MartInnerFragment6();
        pos = i;
        return profileFragment;
    }


    public MartInnerFragment6() {
    }
