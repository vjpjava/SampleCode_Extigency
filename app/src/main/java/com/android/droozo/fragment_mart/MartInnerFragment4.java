 ...
 */
public class MartInnerFragment4 extends Fragment {
    private View view;
    private Activity activity;
    private GridView gridView;
    private static int pos;

    public static MartInnerFragment4 newInstance(int i) {
        MartInnerFragment4 profileFragment = new MartInnerFragment4();
        pos = i;
        return profileFragment;
    }


    public MartInnerFragment4() {
    }
