 ...
 */
public class MartInnerFragment9 extends Fragment {
    private View view;
    private Activity activity;
    private GridView gridView;
    private static int pos;

    public static MartInnerFragment9 newInstance(int i) {
        MartInnerFragment9 profileFragment = new MartInnerFragment9();
        pos = i;
        return profileFragment;
    }


    public MartInnerFragment9() {
    }
