 ...
 */
public class MartInnerFragment0 extends Fragment {
    private View view;
    private Activity activity;
    private GridView gridView;
    private static int pos;

    public static MartInnerFragment0 newInstance(int i) {
        MartInnerFragment0 profileFragment = new MartInnerFragment0();
        pos = i;
        return profileFragment;
    }


    public MartInnerFragment0() {
    }
