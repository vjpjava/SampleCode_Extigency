 ...
 */
public class MartInnerFragment1 extends Fragment {
    private View view;
    private Activity activity;
    private GridView gridView;
    private static int pos;

    public static MartInnerFragment1 newInstance(int i) {
        MartInnerFragment1 profileFragment = new MartInnerFragment1();
        pos = i;
        return profileFragment;
    }


    public MartInnerFragment1() {
    }
